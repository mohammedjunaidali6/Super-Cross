...
import Supercross from '../../img/Supercross.png';
        ...
        <div className="container">
            <div className="row">
                ...
                <div className="header__middle__menus">
                    ...
                    <li className="menu-item" ><NavLink onClick={toggleClass} activeClassName='is-active' to={`/booking`}> Booking </NavLink> </li>
                    <li className="menu-item" ><NavLink onClick={toggleClass} activeClassName='is-active' to={`/Contact`}> Contact </NavLink> </li>
                    <li className="menu-item" id="lo"><NavLink onClick={toggleClass} activeClassName='is-active' to={`/signin`}> Login </NavLink> </li>
